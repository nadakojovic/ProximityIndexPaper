...
load('movie_regressors.mat')
load('pi_asd.mat','pi_asd_allsubjects')

outputpath =fullfile(filesep,'Volumes','CODE_development','Nada','Habituation','PI_REGRESSORS_MOVIE_INPUTS_TD_ASD_MEAN_PI_SALEINCE2')
...
X0=[nanmean(pi_asd_allsubjects,1)]';
input.brain_data=X0;
% --- behavior data ---
...
Y0behav=[visual_complexity,social_complexity,monologue,direct_speech,...
    frame_switch,background_moved, mean_salience_perframe_asd];%

ind=abs(1-any(isnan(Y0behav),2));
...
input.behav_names = {'Visual Complexity', 'Social Complexity','Monologue',...
    'Direct Speech','Frame switch','Moving background','Visual Salience'}
